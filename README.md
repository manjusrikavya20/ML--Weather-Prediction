...
1. Load & Clean the Weather Data
2. Extract hour-based cyclic features (hour_sin, hour_cos) and create lag features (lag1, lag2) for temperature, PM2.5, and solar radiation.
3. Remove rows with missing lag values, split into train and test sets, and train three Random Forest Regressors (one each for temperature, PM2.5, TSR).
4. Compute R², MAE, plot predictions vs actual values, show feature importances, and finally use the latest row to predict the next temperature, pollution, and solar radiation values. 
...
<img width="1140" height="514" alt="image" src="https://github.com/user-attachments/assets/bd7146cf-d9a1-4c86-8660-55b87e40397b" />

<img width="1114" height="426" alt="image" src="https://github.com/user-attachments/assets/4b6d064d-d0cb-40c1-9c8f-18e1ad39bdcb" />
